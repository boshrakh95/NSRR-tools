\begin{table}[ht]
\centering
\caption{Saturation context length L* per task and head (channel: full). L* = smallest context where AUROC(K=all) is within 0.005 of the task maximum. $\Delta$ = absolute AUROC gain from 30\,s to L*.}
\label{tab:lstar_full}
