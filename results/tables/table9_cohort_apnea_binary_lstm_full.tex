\begin{table}[ht]
\centering
\caption{Per-cohort AUROC breakdown for Sleep apnea (AHI≥15) (lstm) at context 120m (channel: full). AUROC computed from mean-probability aggregation over all inference windows per subject.}
\label{tab:cohort_apnea_binary_lstm_full}
