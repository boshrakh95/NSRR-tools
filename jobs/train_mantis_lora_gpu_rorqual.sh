...
# Mantis baseline — Stage 2 Step 1 — LoRA Fine-Tuning Sweep (rorqual-specific)
#
# Identical to train_mantis_lora_gpu.sh except:
...
#
# Auto-resume on timeout: same mechanism as train_mantis_context_sweep_gpu_rorqual.sh
...
#
# Usage examples:
#   sbatch --export=ALL,TASK=apnea_binary,HEAD=lstm jobs/train_mantis_lora_gpu_rorqual.sh
#
...
#       jobs/train_mantis_lora_gpu_rorqual.sh
#
#   # Filter to specific datasets:
#   sbatch --export=ALL,TASK=apnea_binary,HEAD=lstm,DATASETS="apples shhs" jobs/train_mantis_lora_gpu_rorqual.sh
#
#   # Enable tokgen gradient-checkpointing (first memory-mitigation rung):
#   sbatch --export=ALL,TASK=apnea_binary,HEAD=lstm,CONTEXT=240m,CHECKPOINT_TOKGEN=1 jobs/train_mantis_lora_gpu_rorqual.sh
#
# Or single default run (uses task/head from phase0_mantis_lora_config.yaml):
#   sbatch jobs/train_mantis_lora_gpu_rorqual.sh
...
echo "========================================================================"
echo "Mantis baseline — Stage 2 Step 1 — LoRA Fine-Tuning Sweep (rorqual)"
echo "========================================================================"
