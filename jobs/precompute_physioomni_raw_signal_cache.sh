...
#SBATCH --output=/home/boshra95/NSRR-tools/logs_physioomni_lora/precompute_cache_%x_%j.out
#SBATCH --error=/home/boshra95/NSRR-tools/logs_physioomni_lora/precompute_cache_%x_%j.err
