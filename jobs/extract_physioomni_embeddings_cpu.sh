...
#SBATCH --output=/home/boshra95/NSRR-tools/logs_physioomni/extract_cpu_%x_%j.out
#SBATCH --error=/home/boshra95/NSRR-tools/logs_physioomni/extract_cpu_%x_%j.err
