...
# Phase 0 — Subject-level inference (all windows) — rorqual-specific
#
# Identical to infer_subject_windows_gpu.sh except:
...
#       jobs/infer_subject_windows_gpu_rorqual.sh
#
...
#   sbatch --export=ALL,...,SPLIT=val jobs/infer_subject_windows_gpu_rorqual.sh
#
#   # Reproduce training eval exactly (K=5 windows, no --all-windows):
#   sbatch --export=ALL,...,NO_ALL_WINDOWS=1 jobs/infer_subject_windows_gpu_rorqual.sh
#
