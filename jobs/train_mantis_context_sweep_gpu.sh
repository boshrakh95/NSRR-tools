...
#
# Forked from jobs/train_physioomni_context_sweep_gpu.sh (itself forked from
# jobs/train_osf_context_sweep_gpu.sh) — see
...
#   sbatch --export=ALL,TASK=sex_binary,HEAD=mean_pool    jobs/train_mantis_context_sweep_gpu.sh
#   sbatch --export=ALL,TASK=sex_binary,HEAD=transformer  jobs/train_mantis_context_sweep_gpu.sh
#
#   # Filter to specific datasets (space-separated, quoted):
#   sbatch --export=ALL,TASK=sex_binary,HEAD=lstm,DATASETS="apples shhs" jobs/train_mantis_context_sweep_gpu.sh
#
...
#   sbatch --export=ALL,TASK=sex_binary,HEAD=lstm,EMBEDDING_DIR=/scratch/boshra95/psg/unified/embeddings/mantis_pilot12/D_Llast_combined jobs/train_mantis_context_sweep_gpu.sh
#
#   # Disable W&B for a run:
#   sbatch --export=ALL,...,NO_WANDB=1 jobs/train_mantis_context_sweep_gpu.sh
#
...
#   sbatch jobs/train_mantis_context_sweep_gpu.sh
...
echo "========================================================================"
echo "Mantis baseline — Stage 1 Step 8 — Context-Length Sweep"
echo "========================================================================"
